                ...
                <Table stickyHeader>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align=" sx={{ backgroundColor: "var(--primary-light)", fontWeight: "bold" }}>Columns</TableCell>
                      <TableCell align=" sx={{ backgroundColor: "var(--primary-light)", fontWeight: "bold" }}>URL</TableCell>
                      <TableCell align=" sx={{ backgroundColor: "var(--primary-light)", fontWeight: "bold" }}>Edit Table</TableCell>
                      <TableCell align=" sx={{ backgroundColor: "var(--primary-light)", fontWeight: "bold" }}>Delete Table</TableCell>
                      <TableCell align=" sx={{ backgroundColor: "var(--primary-light)", fontWeight: "bold" }}>Select</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
