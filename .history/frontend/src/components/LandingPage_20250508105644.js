          ...
          >
            <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column' }}>
              <ContentContainer>
                ...
                >
                  A web-based platform to manage databases for organizations using an intuitive UI. Allowing organizations to create multiple databases with multiple tables within a database. Facilitating insert, update
