          ...
          >
            <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column' }}>
              <ContentContainer>
                ...
                >
                  A web-based platform to manage databases for organizations through an intuitive UI, facilitating seamless collaboration and data management across organizations.
                </Typography>
                <ButtonGroup
                sx={{ml: 4}}>
                  <Button
