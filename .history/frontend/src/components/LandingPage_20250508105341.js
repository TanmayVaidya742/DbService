          ...
          >
            <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column' }}>
              <ContentContainer>
                ...
                >
                  A web-based platform to manage databases for organizationss from other organizations. Invited users can create and manage databases through an intuitive UI, facilitating seamless collaboration and data management across organizations.
                </Typography>
                <ButtonGroup
                sx={{ml: 4}}>
                  <Button
